...
! Array (1:3) quantities...
      DO IT_0 = 1,3
         ...
         Iflt_Line1(IT_0) = STOF(ISTOF + 33 + IT_0)
      END DO
...
! 40:[var_switch] Two State Switch 'Gen2_switch'
...
! Timed fault logic
      IT_2 = 0
      IF ( TIME .GE. 5.0 ) IT_2 = 1
      IF ( TIME .GE. (5.0+0.3) ) IT_2 = 0

! 170:[tbreakn] Timed Breaker Logic 
! Timed breaker logic
      IF ( TIMEZERO ) THEN
         BRK_Line_1 = 0
      ELSE
         BRK_Line_1 = 0
         IF ( TIME .GE. 5.1 ) BRK_Line_1 = (1-0)
      ENDIF

! 200:[breaker3] 3 Phase Breaker 'BRK_Line_1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 270:[tfaultn] Timed Fault Logic 
! Timed fault logic
      IT_1 = 0
      IF ( TIME .GE. 5.0 ) IT_1 = 1
      IF ( TIME .GE. (5.0+0.3) ) IT_1 = 0
...
! Timed breaker logic
      ...
      ELSE
         BRK_IBRLine_1 = 0
         IF ( TIME .GE. 5.1 ) BRK_IBRLine_1 = (1-0)
      ENDIF

! 300:[breaker3] 3 Phase Breaker 'BRK_IBRLine_1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 370:[breaker3] 3 Phase Breaker 'BRK_IBRLine_1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! 380:[pgb] Output Channel 'Lload'

      PGB(IPGB+13) = Lload

! 390:[pgb] Output Channel 'Rload'
...
! 420:[breaker3] 3 Phase Breaker 'BRK_Line_1'
      IVD1_4 = NSTORI
      NSTORI = NSTORI + 3
! Three Phase Breaker
...
! Array (1:3) quantities...
      DO IT_0 = 1,3
         ...
         STOF(ISTOF + 33 + IT_0) = Iflt_Line1(IT_0)
      END DO
...
! 120:[ammeter] Current Meter 'Iflt_Line1'
      Iflt_Line1(1) = ( CBR((IBRCH(5)+7), SS(5)))
      Iflt_Line1(2) = ( CBR((IBRCH(5)+8), SS(5)))
      Iflt_Line1(3) = ( CBR((IBRCH(5)+9), SS(5)))

! 130:[pgb] Output Channel 'VBus_1'

      PGB(IPGB+1) = VBus_1

! 140:[pgb] Output Channel 'PLine1'

      PGB(IPGB+2) = PLine1

! 160:[pgb] Output Channel 'QLine1'

      PGB(IPGB+3) = QLine1

! 180:[pgb] Output Channel 'VBus_2'

      PGB(IPGB+4) = VBus_2

! 190:[pgb] Output Channel 'PLine2'
...
! 340:[pgb] Output Channel 'QIBR_1'

      PGB(IPGB+10) = QIBR_1

! 350:[pgb] Output Channel 'PIBR_1'

      PGB(IPGB+11) = PIBR_1

! 360:[pgb] Output Channel 'VIBR_1'
...
! 430:[pgb] Output Channel 'PLoad'

      PGB(IPGB+16) = PLoad

! 440:[pgb] Output Channel 'ILoad_inst'

      DO IVD1_1 = 1, 3
         PGB(IPGB+17+IVD1_1-1) = ILoad_inst(IVD1_1)
      ENDDO

! 450:[pgb] Output Channel 'VLoad_inst'

      DO IVD1_1 = 1, 3
         PGB(IPGB+20+IVD1_1-1) = VLoad_inst(IVD1_1)
      ENDDO

! 460:[pgb] Output Channel 'ILoad_rms'

      PGB(IPGB+23) = ILoad_rms

! 470:[pgb] Output Channel 'VLoad_rms'
