...
#------------------------------------------------------------------------------
# Project 'SS_Test_Bench_v5_backup' make using the 'GFortran 4.6.2' compiler.
#------------------------------------------------------------------------------
...
FC_Objects = \
 ...
 Gen1.$(FC_Suffix) \
 IBR.$(FC_Suffix) \
 Simple_PPC.$(FC_Suffix) \
 PI_AntiWindUp_PPC.$(FC_Suffix) \
 VSC.$(FC_Suffix) \
 PIwithFreeze.$(FC_Suffix)
...
Binary   = SS_Test_Bench_v5_backup.exe
